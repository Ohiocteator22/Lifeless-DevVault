...
[![Release](https://img.shields.io/github/v/release/Nityam/DevVault?style=flat-square)](https://github.com/Nityam/DevVault/releases/latest)
...
1. Go to the [latest release](https://github.com/Nityam/DevVault/releases/latest)
...
```powershell
git clone https://github.com/Nityam/DevVault.git
cd DevVault
python -m venv .venv
